...
namespace Data
{
	...
	*/
	...
	public:
		...
		*/
		Edge(qlonglong id, QString name, Data::Graph* graph, Data::Node* srcNode, Data::Node* dstNode, Data::Type* type, bool isOriented, float scaling, int pos = 0);
		...
		*/
		//osg::ref_ptr<Data::VectorArray> getCooridnates() const { return coordinates; }
		...
		*/
		...
		/**
		*  \fn public  updateCoordinates(Data::Vector srcPos, Data::Vector dstNode)
		...
		*/
		void updateCoordinates(Data::Vector srcPos, Data::Vector dstNode);
	...
	private:
		...
		*/
		//osg::ref_ptr<Data::VectorArray> coordinates;
